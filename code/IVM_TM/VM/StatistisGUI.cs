...
namespace VM
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void  lLTable_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            {
                strNewTableName += ".xls";
                tableNameList.Add(strNewTableName);                    
                frmTable fTable = new frmTable(strNewTableName);
                UpdateTableNameList();
                fTable.ShowDialog();
            }
            // string strName = "O";
        ...
        {
            string  strTableName = lBTableNameList.Text;
            frmTable fTable = new frmTable(strTableName);
            fTable.Show();
        }
